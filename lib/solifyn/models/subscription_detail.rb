...
module Solifyn
  ...
  class SubscriptionDetail
    ...
    attr_accessor :purchased_addons
    ...
    def self.openapi_types
      {
        ...
        :'purchased_addons' => :'Array<ResolvedAddon>',
        :'product' => :'SubscriptionDetailProduct'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Solifyn::SubscriptionDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Solifyn::SubscriptionDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'purchased_addons')
        if (value = attributes[:'purchased_addons']).is_a?(Array)
          self.purchased_addons = value
        end
      else
        self.purchased_addons = nil
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payments == o.payments &&
          purchased_addons == o.purchased_addons &&
          product == o.product
    end
    ...
    def hash
      [subscription, payments, purchased_addons, product].hash
    end
