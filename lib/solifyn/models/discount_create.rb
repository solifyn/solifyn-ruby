  ...
  class DiscountCreate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Solifyn::DiscountCreate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Solifyn::DiscountCreate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subscription_cycles')
        self.subscription_cycles = attributes[:'subscription_cycles']
      end

      if attributes.key?(:'restricted_to')
        if (value = attributes[:'restricted_to']).is_a?(Array)
          self.restricted_to = value
        end
      end

      if attributes.key?(:'preserve_on_plan_change')
        self.preserve_on_plan_change = attributes[:'preserve_on_plan_change']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscription_cycles == o.subscription_cycles &&
          restricted_to == o.restricted_to &&
          preserve_on_plan_change == o.preserve_on_plan_change &&
          metadata == o.metadata
    end
    ...
    def hash
      [code, name, type, amount, usage_limit, expires_at, subscription_cycles, restricted_to, preserve_on_plan_change, metadata].hash
    end
