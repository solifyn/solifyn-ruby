...
# Unit tests for Solifyn::OrderBilling
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::OrderBilling do
  let(:instance) { Solifyn::OrderBilling.new }

  describe 'test an instance of OrderBilling' do
    it 'should create an instance of OrderBilling' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::OrderBilling)
    end
  end
