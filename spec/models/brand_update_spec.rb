...
# Unit tests for Solifyn::BrandUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::BrandUpdate do
  let(:instance) { Solifyn::BrandUpdate.new }

  describe 'test an instance of BrandUpdate' do
    it 'should create an instance of BrandUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::BrandUpdate)
    end
  end
