...
# Unit tests for Solifyn::OrderRefund
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::OrderRefund do
  let(:instance) { Solifyn::OrderRefund.new }

  describe 'test an instance of OrderRefund' do
    it 'should create an instance of OrderRefund' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::OrderRefund)
    end
  end
  ...
  describe 'test attribute "is_partial"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
