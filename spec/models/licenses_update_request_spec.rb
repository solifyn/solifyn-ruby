...
# Unit tests for Solifyn::LicensesUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::LicensesUpdateRequest do
  let(:instance) { Solifyn::LicensesUpdateRequest.new }

  describe 'test an instance of LicensesUpdateRequest' do
    it 'should create an instance of LicensesUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::LicensesUpdateRequest)
    end
  end
