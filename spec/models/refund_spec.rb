...
# Unit tests for Solifyn::Refund
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::Refund do
  let(:instance) { Solifyn::Refund.new }

  describe 'test an instance of Refund' do
    it 'should create an instance of Refund' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::Refund)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "succeeded", "failed", "canceled"])
