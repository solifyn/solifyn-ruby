...
# Unit tests for Solifyn::CreateCustomerDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::CreateCustomerDto do
  let(:instance) { Solifyn::CreateCustomerDto.new }

  describe 'test an instance of CreateCustomerDto' do
    it 'should create an instance of CreateCustomerDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::CreateCustomerDto)
    end
  end
