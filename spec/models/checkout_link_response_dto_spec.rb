...
# Unit tests for Solifyn::CheckoutLinkResponseDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::CheckoutLinkResponseDto do
  let(:instance) { Solifyn::CheckoutLinkResponseDto.new }

  describe 'test an instance of CheckoutLinkResponseDto' do
    it 'should create an instance of CheckoutLinkResponseDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::CheckoutLinkResponseDto)
    end
  end
