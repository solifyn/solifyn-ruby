...
# Unit tests for Solifyn::WebhookLicensePayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::WebhookLicensePayload do
  let(:instance) { Solifyn::WebhookLicensePayload.new }

  describe 'test an instance of WebhookLicensePayload' do
    it 'should create an instance of WebhookLicensePayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::WebhookLicensePayload)
    end
  end
