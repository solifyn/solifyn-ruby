...
# Unit tests for Solifyn::UpdateEntitlementDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::UpdateEntitlementDto do
  let(:instance) { Solifyn::UpdateEntitlementDto.new }

  describe 'test an instance of UpdateEntitlementDto' do
    it 'should create an instance of UpdateEntitlementDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::UpdateEntitlementDto)
    end
  end
