...
# Unit tests for Solifyn::ProductUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::ProductUpdate do
  let(:instance) { Solifyn::ProductUpdate.new }

  describe 'test an instance of ProductUpdate' do
    it 'should create an instance of ProductUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::ProductUpdate)
    end
  end
