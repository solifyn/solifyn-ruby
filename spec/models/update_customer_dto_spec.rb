...
# Unit tests for Solifyn::UpdateCustomerDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::UpdateCustomerDto do
  let(:instance) { Solifyn::UpdateCustomerDto.new }

  describe 'test an instance of UpdateCustomerDto' do
    it 'should create an instance of UpdateCustomerDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::UpdateCustomerDto)
    end
  end
