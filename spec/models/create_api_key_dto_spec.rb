...
# Unit tests for Solifyn::CreateApiKeyDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::CreateApiKeyDto do
  let(:instance) { Solifyn::CreateApiKeyDto.new }

  describe 'test an instance of CreateApiKeyDto' do
    it 'should create an instance of CreateApiKeyDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::CreateApiKeyDto)
    end
  end
