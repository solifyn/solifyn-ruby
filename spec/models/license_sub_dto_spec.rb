...
# Unit tests for Solifyn::LicenseSubDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::LicenseSubDto do
  let(:instance) { Solifyn::LicenseSubDto.new }

  describe 'test an instance of LicenseSubDto' do
    it 'should create an instance of LicenseSubDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::LicenseSubDto)
    end
  end
