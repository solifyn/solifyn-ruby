...
# Unit tests for Solifyn::BrandCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::BrandCreate do
  let(:instance) { Solifyn::BrandCreate.new }

  describe 'test an instance of BrandCreate' do
    it 'should create an instance of BrandCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::BrandCreate)
    end
  end
