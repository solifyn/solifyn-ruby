...
# Unit tests for Solifyn::CreateCheckoutLinkDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Solifyn::CreateCheckoutLinkDto do
  let(:instance) { Solifyn::CreateCheckoutLinkDto.new }

  describe 'test an instance of CreateCheckoutLinkDto' do
    it 'should create an instance of CreateCheckoutLinkDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Solifyn::CreateCheckoutLinkDto)
    end
  end
